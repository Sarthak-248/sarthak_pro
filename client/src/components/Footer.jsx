...
export default function Footer() {
  ...
  const handleSubscribe = (e) => {
    ...
    formData.append(
      '_autoresponse',
      'Thank you for subscribing to Sarthak Heights! We will keep you updated with latest news and listings.'
    );

    fetch('https://formsubmit.co/ajax/sarthakmor78@gmail.com', {
      method: 'POST',
      headers: {
        ...
        <div className="max-w-7xl mx-auto grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-12 border-b border-white/20 pb-12">
          ...
          <div>
            ...
            <p className="text-sm text-gray-300 leading-relaxed">
              Helping you unlock the door to your dream home. Listings,
              insights, and deals — all in one place.
            </p>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm text-gray-300">
              ...
              <li>
                <a href="/search" className="hover:text-yellow-400 transition">
                  🔍 Search Listings
                </a>
              </li>
              <li>
          ...
          <div>
            ...
            <form onSubmit={handleSubscribe} className="flex mb-4">
              ...
              <button
                type="submit"
                className="bg-yellow-400 text-black px-4 py-2 rounded-r-md hover:bg-yellow-300 transition"
              >
                Subscribe
              </button>
            </form>
            {status && (
              <p className="text-yellow-300 text-sm font-semibold mt-2">{status}</p>
            )}
            <div className="flex gap-4 mt-4">
              <a
                href="https://www.linkedin.com/in/sarthak-morgaonkar"
                target="_blank"
                rel="noopener noreferrer"
                className="bg-white/10 p-2 rounded-full hover:bg-yellow-400 hover:text-black transition"
              >
                <FaLinkedinIn />
              </a>
              <a
